...
int createParamWindow(int width, int height, SGtext title, int mode, void(*setup)(void *), vect loop, void *init) {
	WNDCLASSEX wc;
...
void alertInfo(SGtext caption, SGtext text, int mode, void(*result)(int)) {
	...
	createParamWindow(400, 20 * line + 80, caption, BIT_MAP, [](void *param) {
